...
#define MBED_CONF_MBED_TRACE_ENABLE                                       1                                                            // set by application[DISCO_H747I]
...
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_SET_FLOATING_POINT_MAX_DECIMALS 2                                                            // set by application[*]
...
#define MBED_TRACE_MAX_LEVEL                                              TRACE_LEVEL_DEBUG                                            // set by application[DISCO_H747I]
#define MEM_ALLOC                                                         malloc                                                       // set by library:mbed-trace
#define MEM_FREE                                                          free                                                         // set by library:mbed-trace
// Macros
#define MBED_CONF_MBED_TRACE_FEA_IPV6                                     0                                                            // defined by application
